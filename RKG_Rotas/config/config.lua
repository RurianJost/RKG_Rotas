CONFIG = {
    ...
    ROUTES = {
        ['Favelas'] = { 
            ...
            PED = {
                LOCATION = vector3(1220.47, -2964.51, 5.87), 
                HEADING = 92.79, 
                HASHS = { 0x4F2E038A, 'a_m_m_salton_01' }, 
                TEXT = '~r~[E]~w~ PARA INICIAR A ROTA', 
            }, 
           
            PERMISSIONS = { 'Admin', 'Barragem', 'Campinho' }, 
            
            RANDOM_ITEMS = true, 
           
            ITEMS = {
                { NAME = 'elastic', MINIMUM = 3, MAXIMUM = 5 }, 
                { NAME = 'emptybottle', MINIMUM = 5, MAXIMUM = 7 }, 
            }, 
        ...
        ['Mecanica'] = { 
            ...
            PED = {
                LOCATION = vector3(1220.47, -2962.51, 5.87), 
                HEADING = 92.79, 
                HASHS = { 0x4F2E038A, 'a_m_m_salton_01' }, 
                TEXT = '~r~[E]~w~ PARA INICIAR A ROTA', 
            }, 
    ...
    LANGUAGE = {
        ROUTE_STARTED = 'Você iniciou sua rota.', 
        ROUTE_STOPED = 'Você saiu da rota.', 
        FULL_BACKPACK = 'A sua mochila está cheia.',
        COMMAND_LABEL = 'Cancelar rota',
        BLIP_LABEL = 'Coleta de itens'
    }
}
